"""
preprocess.py
Fungsi preprocessing — Identik dengan yang dipakai saat training
di notebook (6 tahap: case folding, cleaning, normalisasi, tokenisasi,
stopword removal, stemming).

Modul ini memuat kamus slangword, stopword, dan stemmer saat
...
# Auto-download NLTK punkt (server cloud tidak punya secara default) 
try:
