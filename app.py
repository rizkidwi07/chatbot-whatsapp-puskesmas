...
Logika inferensi PERSIS sama dengan fungsi chatbot() di notebook:
...
# ── Load bundle SEKALI saat server start ─────────────────────────────────
...
# WAJIB diisi lewat Environment Variables di Railway, JANGAN hardcode di sini.
WA_TOKEN     = os.environ.get('WA_TOKEN', '')
PHONE_ID     = os.environ.get('PHONE_ID', '')
VERIFY_TOKEN = os.environ.get('VERIFY_TOKEN', 'puskesmas_cijagra_token')
